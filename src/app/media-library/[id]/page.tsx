  ...
  if (error || !asset) {
    return (
      <div className="text-center py-16">
        ...
        <Link href="/media-library" className="btn-ghost btn-sm mt-4 inline-block">← Back to Media Library</Link>
      </div>
    )
  }
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <Link href="/media-library" className="text-stone-400 hover:text-stone-600 dark:hover:text-stone-200 transition-colors">
